        ...
        case 509:   // 查询镜头倍率
            switch (self.managerLens) {
                case JYBlueManagerLensOne:
                    [self blueToolWriteValue:@"a05140000b"];
                    break;
                case JYBlueManagerLensTwo:
                    [self blueToolWriteValue:@"a05140001b"];
                    break;
                case JYBlueManagerLensThree:
                    [self blueToolWriteValue:@"a05140002b"];
                    break;
            }
            break;
        ...
        case 512:   // 重复最后一次
            switch (self.videoType) {
                case JYResetVideoTypeOne:
                    [self blueToolWriteValue:@"a05170000b"];
                    break;
                case JYResetVideoTypeTwo:
                    [self blueToolWriteValue:@"a05170001b"];
                    break;
            }
            break;
